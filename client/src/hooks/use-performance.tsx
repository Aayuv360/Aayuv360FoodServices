  ...
  const prefetchCriticalData = useCallback(async () => {
    try {
      ...
      await Promise.allSettled([
        ...
        prefetchData('subscriptionPlans', () => fetch('/api/subscription-plans').then(r => r.json())),
      ]);
    } catch (error) {
...
export const LazyComponents = {
  AdminPortal: () => import('@/pages/admin-portal').then(m => ({ default: m.default })),
  Analytics: () => import('@/pages/analytics').then(m => ({ default: m.default })),
  OrderManagement: () => import('@/pages/order-management').then(m => ({ default: m.default })),
};
