          ...
          <div className="container mx-auto relative z-10">
            ...
            >
              ...
              <p className="text-base text-gray-600 leading-relaxed">
                We're on a mission to bring the ancient wisdom of millet
                nutrition to modern tables, making healthy eating convenient,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    Founded with a passion for nutrition and sustainability,
                    Aayuv was born from the recognition that modern diets often
                    lack the essential nutrients our ancestors enjoyed through
                    millet-based foods.
                  </p>
                  <p>
                    Our journey began when we realized that despite the proven
                    health benefits of millets - being gluten-free, rich in
                    fiber, and packed with essential minerals - they were
                    disappearing from our daily meals due to busy lifestyles.
                  </p>
                  <p>
                    Today, we're proud to serve thousands of health-conscious
                    individuals who trust us to deliver nutritious, delicious
                    meals that honor traditional recipes while fitting
          ...
          <div className="container mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We're expanding across major cities to bring healthy millet
