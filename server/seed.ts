...
export async function seedDatabase() {
  try {
    ...
    if (existingPlans.length === 0) {
      ...
      const subscriptionPlans = [
        ...
        },
        {
          ...
          menuItems: [
            {
              day: 1,
              main: "Multi-Millet Power Bowl",
              sides: ["Avocado", "Tahini"],
            },
            {
              day: 2,
              main: "Pearl Millet Pizza Base",
              sides: ["Vegetables", "Cheese"],
            },
            {
              day: 3,
              main: "Finger Millet Granola",
              sides: ["Fruits", "Yogurt"],
            },
            {
              day: 4,
              main: "Foxtail Millet Pasta",
              sides: ["Tomato Sauce", "Herbs"],
            },
            { day: 5, main: "Kodo Millet Kheer", sides: ["Nuts", "Cardamom"] },
            {
              day: 6,
              main: "Barnyard Millet Risotto",
              sides: ["Mushrooms", "Cheese"],
            },
            {
              day: 7,
              main: "Little Millet Tabbouleh",
              sides: ["Herbs", "Lemon"],
            },
          ],
        },
        {
          ...
          description:
            "Large portions for families with diverse millet options",
          price: 5000,
          duration: 30,
          mealsPerDay: 4,
          dietaryPreference: "veg",
          ...
          menuItems: [
            {
              day: 1,
              main: "Pearl Millet Pancakes",
              sides: ["Honey", "Fruits"],
            },
            {
              day: 2,
              main: "Finger Millet Dosa",
              sides: ["Chutney", "Sambar"],
            },
            {
              day: 3,
              main: "Foxtail Millet Wrap",
              sides: ["Hummus", "Vegetables"],
            },
            {
              day: 4,
              main: "Kodo Millet Ice Cream",
              sides: ["Nuts", "Berries"],
            },
            {
              day: 5,
              main: "Barnyard Millet Burger",
              sides: ["Fries", "Salad"],
            },
      ...
      await Promise.all(
        subscriptionPlans.map((plan) => SubscriptionPlanModel.create(plan)),
      );
      console.log(
